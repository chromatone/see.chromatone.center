import { ArrowDescriptor, ArrowOptions } from './getBoxToBoxArrow';
/**
 ...
 */
export default function getArrow(x0: number, y0: number, x1: number, y1: number, userOptions?: ArrowOptions): ArrowDescriptor;
