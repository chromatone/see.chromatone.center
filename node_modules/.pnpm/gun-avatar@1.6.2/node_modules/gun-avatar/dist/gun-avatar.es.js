...
function gunAvatar({
  ...
  if (!pub)
    return;
  if ((_b = (_a = cache == null ? void 0 : cache[draw]) == null ? void 0 : _a[size]) == null ? void 0 : _b[pub])
...
function drawSquares(data, ctx, size) {
  ...
  chunks.forEach((chunk) => {
    if (chunk.length == 14) {
      ...
      let a2 = chunk[11];
      let x2 = chunk[12];
      const gradient = ctx.createLinearGradient(x + r * x1, 0, x + r * x2, size);
...
export { gunAvatar, mountClass, mountElement };
